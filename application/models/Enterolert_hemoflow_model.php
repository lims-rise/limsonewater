...
class Enterolert_hemoflow_model extends CI_Model
{
    ...
    function json() {
        ...
        if ($lvl == 4){
            $this->datatables->add_column('action', anchor(site_url('enterolert_hemoflow/read/$1'),'<i class="fa fa-th-list" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-sm')), 'id_one_water_sample');
            // $this->datatables->add_column('action', '-', 'id_one_water_sample');
        }
        else if ($lvl == 3){
            $this->datatables->add_column('action', anchor(site_url('enterolert_hemoflow/read/$1'),'<i class="fa fa-th-list" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-sm')) ."
    ...
    function get_by_id($id)
    {
        ...
        return $this->db->get('enterolert_hemoflow')->row();
    }
