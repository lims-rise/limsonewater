...
class Colilert_idexx_biosolids_model extends CI_Model
{
    ...
    function subjson($id) {
        ...
        cbo.ecoli, cbo.lowerdetection, cbo.ecoli_dryweight, cbo.ecoli_dryweight_is_less_than, cbo.lowerdetection_dryweight, cbo.coliforms_largewells, cbo.coliforms_smallwells, cbo.total_coliforms, cbo.total_coliforms_mpn_dry_weight, cbo.remarks, cbo.quality_control, cbo.flag');
    ...
    function get_by_id($id)
    {
        ...
        return $this->db->get('colilert_biosolids_in')->row();
    }
    ...
    function delete_colilert_idexx_biosolids($id, $data)
    {
        $this->db->where('id_one_water_sample', $id);
        $this->db->where('flag', '0');
        $this->db->update('colilert_biosolids_in', $data);
