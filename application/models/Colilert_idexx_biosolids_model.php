...
class Colilert_idexx_biosolids_model extends CI_Model
{
    ...
    function subjson($id) {
        ...
        cbo.ecoli, cbo.lowerdetection, cbo.ecoli_dryweight, cbo.ecoli_dryweight_is_less_than, cbo.lowerdetection_dryweight, cbo.coliforms_largewells, cbo.coliforms_smallwells, cbo.total_coliforms, cbo.remarks, cbo.quality_control, cbo.flag');
