...
class Microbial_extraction_model extends CI_Model
{
    ...
    public function insert_batch($data)
    {
        ...
        return $this->db->insert_batch('microbial_extraction_results', $data);
    }
    ...
    public function get_by_project($project_id)
    {
        ...
        $query = $this->db->get('microbial_extraction_results');
    ...
    {
        $this->db->where('id_project', $project_id);
        $count = $this->db->count_all_results('microbial_extraction_results');
        return $count > 0;
    }
