    ...
    $(document).ready(function() {
        ...
        function checkDryWeight(buttonElement, inputSelector) {
            ...
            setTimeout(function() {
                ...
                $.ajax({
                    url: '<?php echo site_url('Enterolert_idexx_biosolids/checkDryWeight'); ?>',
                    type: 'POST',
        ...
        $('.idOneWaterSampleSelect').change(function() {
            ...
            if (id_one_water_sample) {
                $.ajax({
                    url: '<?php echo site_url('Enterolert_idexx_biosolids/getIdOneWaterDetails'); ?>', // URL untuk request AJAX
                    type: 'POST',
        ...
        $('#id_one_water_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "Enterolert_idexx_biosolids/barcode_restrict?id1="+id_one_water_sample,
                dataType: "json",
