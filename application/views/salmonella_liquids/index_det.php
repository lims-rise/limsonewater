            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #3c8dbc; color: white;">
                        ...
                        <form id="formDetail24" action=<?php echo site_url('Salmonella_liquids/saveResultsCharcoal') ?> method="post" class="form-horizontal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #3c8dbc; color: white;">
                        ...
                        <form id="formDetail24" action=<?php echo site_url('Salmonella_liquids/saveResultsHBA') ?> method="post" class="form-horizontal">
                            <div class="modal-body">
                                <div class="form-group">
                                        <div class="col-sm-9">
                                            ...
                                            <!-- <input id="idx_moisture24" name="idx_moisture24" type="hidden" class="form-control input-sm">
                                            <input id="id_moisture24" name="id_moisture24" type="hidden" class="form-control input-sm"> -->
                                            <input id="id_salmonella_liquidsHBA" name="id_salmonella_liquidsHBA" type="hidden" class="form-control input-sm">
    ...
    function updateConfirmation() {
        ...
        $(document).on('click', '.btn_deleteCharcoal, .btn_deleteHba, .btn_deleteBiochemical', function() {
            ...
            if ($(this).hasClass('btn_deleteCharcoal')) {
                url = '<?php echo site_url('Salmonella_liquids/delete_detailCharcoal'); ?>/' + id;
                ...
                url = '<?php echo site_url('Salmonella_liquids/delete_detailHba'); ?>/' + id;
        ...
        table = $("#example2").DataTable({
            ...
            info: false,
            bFilter: false,
            ajax: {"url": "../../Salmonella_liquids/subjsonCharcoal?idCharcoal="+id_salmonella_liquids, "type": "POST"},
            columns: [
        ...
        table1 = $("#exampleHba").DataTable({
            ...
            info: false,
            bFilter: false,
            ajax: {"url": "../../Salmonella_liquids/subjsonHba?idHba="+id_salmonella_liquids, "type": "POST"},
            columns: [
                {"data": "salmonella_assay_barcode"},
                {"data": "date_sample_processed"},
                {"data": "time_sample_processed"},
        ...
        table1.ajax.reload(function() {
            ...
            if (data) {
                ...
                generateResultBiochemical($('#content-result-biochemical'), plateNumberArray.length, data.id_salmonella_liquids, plateNumberArray, growthPlateArray);
            } else {
        ...
        function generateResultBiochemical(container, numberOfPlates, id_salmonella_liquids, plateNumberArray, growthPlateArray) {
        ...
        $('#addtombol_detResultsHBA').on('click', function() {
            ...
            if (data && data.salmonella_assay_barcode) {
                ...
                $('#id_salmonella_liquidsHBA').val(id_salmonella_liquids);
        ...
        $('#exampleHba').on('click', '.btn_edit_detResultsHba', function() {
            ...
            $('#salmonella_assay_barcodeHBA').attr('readonly', true);
            $('#id_salmonella_liquidsHBA').val(data.id_salmonella_liquids);
