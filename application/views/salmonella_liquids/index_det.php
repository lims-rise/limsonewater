    ...
    function generateColonyPlateInputs(container, numberOfTubes) {
        ...
        table1.ajax.reload(function() {
            ...
            if (data) {
                ...
                generateResultBiochemical($('#content-result-biochemical'), plateNumberArray.length, data.id_salmonella_liquids, plateNumberArray, blackColonyPlateArray);
            } else {
        ...
        function generateResultBiochemical(container, numberOfPlates, id_salmonella_liquids, plateNumberArray, blackColonyPlateArray) {
