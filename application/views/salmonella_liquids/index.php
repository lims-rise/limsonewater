            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header">
                        <h3 class="box-title">Processing | Salmonella Liquids </h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <!-- <?php
                                    ...
                                    if ($lvl != 4){
                                        echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Salmonella Liquids</button>";
                                    }
                            ?>         -->
                            <?php echo anchor(site_url('Salmonella_liquids/excel_all'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to XLS', 'class="btn btn-success"'); ?>
                        </div>
    ...
    <div class="modal fade"  id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true" data-bs-scrollable="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSample" action="<?php echo site_url('Salmonella_liquids/save') ?>" method="post" class="form-horizontal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #dd4b39; color: white;">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white;">&times;</button>
                <h4 class="modal-title"><i class="fa fa-trash"></i> Salmonella Liquids | Delete <span id="my-another-cool-loader"></span></h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if (barcodeFromUrl) {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Salmonella Liquids | New<span id="my-another-cool-loader"></span>');
        ...
        $(document).on('click', '.btn_deleteSalmonellaLiquids', function() {
            let id = $(this).data('id');
            let url = '<?php echo site_url('Salmonella_liquids/delete_salmonellaLiquids'); ?>/' + id;
        ...
        $('.idOneWaterSampleSelect').change(function() {
            ...
            if (id_one_water_sample) {
                $.ajax({
                    url: '<?php echo site_url('Salmonella_liquids/getIdOneWaterDetails'); ?>', // URL untuk request AJAX
                    type: 'POST',
        ...
        $('#id_one_water_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "Salmonella_liquids/barcode_restrict?id1="+id_one_water_sample,
                dataType: "json",
        ...
        $('#salmonella_assay_barcode').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "Salmonella_liquids/validateSalmonellaAssayBarcode",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Salmonella_liquids/json", "type": "POST", "error": function(xhr, error, code) {
        ...
        $('#mytable tbody').on('click', 'tr', function() {
            ...
            let rowId = rowData.id_salmonella_liquids;
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#id_salmonella_liquids').val(data.id_salmonella_liquids);
