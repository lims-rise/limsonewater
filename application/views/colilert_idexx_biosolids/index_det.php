			...
			<div class="box-footer">
				...
				<div class="form-group">
					<div class="modal-footer clearfix">
                        <button type="button" name="batal" value="batal" class="btn btn-warning" onclick='window.location.href=<?= json_encode(isset($return_url) ? $return_url : site_url("colilert_idexx_biosolids")); ?>;'>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                        <div class="col-sm-9">
                                            ...
                                            <input id="return_urlDetail" name="return_url" type="hidden" value="<?= htmlspecialchars(isset($return_url) ? $return_url : site_url('colilert_idexx_biosolids'), ENT_QUOTES, 'UTF-8'); ?>" class="form-control input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="ecoli" name="ecoli" type="text"  placeholder="E. coli MPN/100 mL" class="form-control" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="total_coliforms" name="total_coliforms" type="text"  placeholder="Total Coliforms (raw MPN)" class="form-control" readonly>
                                            <!-- <div class="val1tip"></div> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="quality_control_cib" name="quality_control_cib" value="1">
    ...
    $(document).ready(function() {
	  ...
	  $('#review_label')
        ...
        $('#addtombol_det').click(function() {
            ...
            $('#quality_control_cib').prop('checked', false);
        ...
        $('#example2').on('click', '.btn_edit_det', function() {
            ...
            $('#quality_control_cib').prop('checked', data.quality_control == '1');
            $('#compose-modal').modal('show');
            
            // Auto calculation when modal opens for edit - display formatted values
            setTimeout(function() {
                // Trigger calculation for E.coli - display formatted values
