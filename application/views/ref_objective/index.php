            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header">
                        <h3 class="box-title">Master Data - Objective</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php
                                    ...
                                    if ($lvl != 7){
                                        echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Objective </button>";
                                    }
                            ?>        
                ...
                <form id="formSample"  action= <?php echo site_url('Ref_objective/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="objective" name="objective" type="text" class="form-control" placeholder="Objective Name" required>
                            </div>
                            </div>
                    </div>
