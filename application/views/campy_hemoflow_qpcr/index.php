            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    <div class="box-header">
                        <h3 class="box-title">Processing | Campy Hemoflow Qpcr </h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <!-- <?php
                                    ...
                                    if ($lvl != 4){
                                        echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Campy Hemoflow Qpcr</button>";
                                    }
                            ?>         -->
                            <?php echo anchor(site_url('Campy_hemoflow_qpcr/excel_all'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to XLS', 'class="btn btn-success"'); ?>
                        </div>
    ...
    <div class="modal fade"  id="compose-modal" tabindex="-1" role="dialog" aria-hidden="true" data-bs-scrollable="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formSample" action="<?php echo site_url('Campy_hemoflow_qpcr/save') ?>" method="post" class="form-horizontal">
                    <div class="modal-body">
                        <input id="mode" name="mode" type="hidden" class="form-control input-sm">
                        <input id="id_campy_hemoflow_qpcr" name="id_campy_hemoflow_qpcr" type="hidden" class="form-control input-sm">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #dd4b39; color: white;">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: white;">&times;</button>
                <h4 class="modal-title"><i class="fa fa-trash"></i> Campy Hemoflow Qpcr | Delete <span id="my-another-cool-loader"></span></h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if (barcodeFromUrl && idOneWaterSampleFromUrl) {
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Campy Hemoflow Qpcr | New<span id="my-another-cool-loader"></span>');
        ...
        $('.idOneWaterSampleSelect').change(function() {
            ...
            if (id_one_water_sample) {
                $.ajax({
                    url: '<?php echo site_url('Campy_hemoflow_qpcr/getIdOneWaterDetails'); ?>', // URL untuk request AJAX
                    type: 'POST',
        ...
        function checkDryWeight(buttonElement, inputSelector) {
            ...
            setTimeout(function() {
                ...
                $.ajax({
                    url: '<?php echo site_url('Campy_hemoflow_qpcr/getDryWeight'); ?>',
                    type: 'POST',
        ...
        $('#id_one_water_sample').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "Campy_hemoflow_qpcr/barcode_restrict?id1="+id_one_water_sample,
                dataType: "json",
        ...
        $('#campy_assay_barcode').on("change", function() {
            ...
            $.ajax({
                type: "GET",
                url: "Campy_hemoflow_qpcr/validateCampyAssayBarcode",
        ...
        $('#mytable tbody').on('click', 'tr', function() {
            ...
            let rowId = rowData.id_campy_hemoflow_qpcr;
        ...
        //     console.log(data);
        //     $('#mode').val('edit');
        //     $('#modal-title').html('<i class="fa fa-pencil-square"></i> Campy Hemoflow Qpcr | Update<span id="my-another-cool-loader"></span>');
        //     $('#id_campy_hemoflow_qpcr').val(data.id_campy_hemoflow_qpcr);
