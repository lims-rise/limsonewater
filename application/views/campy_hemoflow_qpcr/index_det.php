	...
	<section class="content">
		<div class="box box-black box-solid">
			<div class="box-header with-border">
				...
				<form role="form"  id="formKeg" method="post" class="form-horizontal">
					<div class="box-body">
						...
						<input id="id_campy_hemoflow_qpcr" name="id_campy_hemoflow_qpcr" type="hidden" class="form-control input-sm" value="<?php echo $id_campy_hemoflow_qpcr ?>">
			...
			<div class="box-footer">
                    <div class="col-xs-12"> 
                        <div class="box box-primary box-solid">
                            <div class="box-header">
                                <h3 class="box-title">Results MPN-PCR</h3>
                            </div>
							<div class="box-body pad table-responsive">
								<?php
									$lvl = $this->session->userdata('id_user_level');
									if ($lvl != 4){
										echo "<button class='btn btn-primary' id='addtombol_detResultsMpnpcr'><i class='fa fa-wpforms' aria-hidden='true'></i> New Data</button>";
									}
								?>
                    ...
                    <!-- COMMENTED: HBA Section - Future Use -->
                    <!--
                    <div class="col-xs-12"> 
                        <div class="box box-primary box-solid">
                            <div class="box-header">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #3c8dbc; color: white;">
                        ...
                        <form id="formDetail24" action=<?php echo site_url('Campy_hemoflow_qpcr/saveResultsMpnpcr') ?> method="post" class="form-horizontal">
                            <div class="modal-body">
                                <div class="form-group">
                                        <div class="col-sm-9">
                                            <input id="mode_detResultsMpnpcr" name="mode_detResultsMpnpcr" type="hidden" class="form-control input-sm">
                                            ...
                                            <input id="id_campy_hemoflow_qpcr1" name="id_campy_hemoflow_qpcr1" type="hidden" class="form-control input-sm">
...
<!-- COMMENTED: MODAL FORM Results HBA - Future Use -->
<!--
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #3c8dbc; color: white;">
                        ...
                        <form id="formDetail24" action=<?php echo site_url('Campy_hemoflow_qpcr/saveResultsHBA') ?> method="post" class="form-horizontal">
                            <div class="modal-body">
                                <div class="form-group">
                                        <div class="col-sm-9">
                                            ...
                                            <input id="idx_moisture24" name="idx_moisture24" type="hidden" class="form-control input-sm">
                                            <input id="id_moisture24" name="id_moisture24" type="hidden" class="form-control input-sm">
                                            <input id="id_campy_hemoflow_qpcrHBA" name="id_campy_hemoflow_qpcrHBA" type="hidden" class="form-control input-sm">
                                            <input id="number_of_tubesHba" name="number_of_tubesHba" type="hidden" class="form-control input-sm">
                                            <input id="id_campy_hemoflow_qpcr_result_hba" name="id_campy_hemoflow_qpcr_result_hba" type="hidden" class="form-control input-sm">
...
<div class="modal fade" id="compose-modalBiochemical" tabindex="-1" role="dialog" aria-hidden="true" data-bs-scrollable="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formBiochemical" action="<?php echo site_url('Campy_hemoflow_qpcr/saveBiochemicalFromMpnpcr') ?>" method="post" class="form-horizontal">
                <div class="modal-body">
                    <input id="mode_detResultsBiochemical" name="mode_detResultsBiochemical" type="hidden" class="form-control input-sm">
                    <input id="id_campy_hemoflow_qpcrBiochemical" name="id_campy_hemoflow_qpcrBiochemical" type="hidden" class="form-control input-sm">
                    <input id="id_campy_hemoflow_qpcr_result_biochemical" name="id_campy_hemoflow_qpcr_result_biochemical" type="hidden" class="form-control input-sm">
...
<div class="modal fade" id="compose-modalCalculateMPN" tabindex="-1" role="dialog" aria-hidden="true" data-bs-scrollable="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formCalculateMPN" action="<?php echo site_url('Campy_hemoflow_qpcr/saveCalculateMPN') ?>" method="post" class="form-horizontal">
                <div class="modal-body">
                    <input id="mode_calculateMPN" name="mode_calculateMPN" type="hidden" class="form-control input-sm">
                    <input id="id_campy_hemoflow_qpcr_mpn" name="id_campy_hemoflow_qpcr_mpn" type="hidden" class="form-control input-sm">
...
<script>
    document.getElementById('exportBtn').addEventListener('click', function() {
        let id_campy_hemoflow_qpcr = document.getElementById('id_campy_hemoflow_qpcr').value;
        window.location.href = '<?php echo site_url("Campy_hemoflow_qpcr/excel"); ?>/' + id_campy_hemoflow_qpcr;
    });
    ...
    document.getElementById('calculateMpnBtn').addEventListener('click', function() {
        ...
        */
        ...
        // Set the id_campy_hemoflow_qpcr value in the modal
        document.getElementById('id_campy_hemoflow_qpcr_mpn').value = id_campy_hemoflow_qpcr;

        // Check if MPN calculation already exists
        $.ajax({
            url: '<?php echo site_url("Campy_hemoflow_qpcr/getCalculateMPN"); ?>',
            type: 'GET',
            data: { id_campy_hemoflow_qpcr: id_campy_hemoflow_qpcr },
            dataType: 'json',
            success: function(response) {
                if (response.status === 'success') {
                    // Data exists, set to edit mode
                    document.getElementById('mode_calculateMPN').value = 'edit';
                    document.getElementById('id_campy_result_mpn').value = response.data.id_campy_hemoflow_qpcr_result_mpn || response.data.id_campy_hemoflow_qpcr_result_mpn;
...
<script type="text/javascript">
    ...
    let id_campy_hemoflow_qpcr = $('#id_campy_hemoflow_qpcr').val();
    ...
    $(document).ready(function() {
        ...
        <?php if ($this->session->flashdata('message')): ?>
            ...
            if (flashMessage.includes('HBA Results auto-generated')) {
                ...
                Swal.fire({
                    ...
                    //         <p><i class="fa fa-magic" style="color: #28a745; margin-right: 8px;"></i><strong>All growth plates in Results MPN-PCR were 0</strong></p>
		...
		// 				$.ajax({
		// 					url: '<?php echo site_url("Campy_hemoflow_qpcr/saveReview"); ?>',
		// 					method: 'POST',
    ...
    $('#cancelReviewBtn').on('click', function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '<?php echo site_url("Campy_hemoflow_qpcr/cancelReview"); ?>',
                    method: 'POST',
                    data: formData,
                    dataType: 'json',
                    success: function (response) {
	  ...
	  $('#review_label')
        ...
        $(document).on('click', '.btn_deleteMpnpcr, .btn_deleteHba, .btn_deleteBiochemical', function() {
            let id = $(this).data('id');
            let url;
            if ($(this).hasClass('btn_deleteMpnpcr')) {
                url = '<?php echo site_url("Campy_hemoflow_qpcr/delete_detailMpnpcr"); ?>/' + id;
                $('.modal-title').html('<i class="fa fa-trash"></i> Result MPN-PCR | Delete <span id="my-another-cool-loader"></span>');
                $('#confirm-modal-delete #id').text(id);
                
                // Add warning about cascade delete for Mpnpcr
                $('#confirm-modal-delete .modal-body').html(
                    '<p><strong>⚠️ Critical Warning:</strong> Deleting this MPN-PCR result will also delete ALL related data including:</p>' +
                    ...
                    '<p>Are you sure you want to delete Result MPN-PCR <strong>' + id + '</strong> and all its related data?</p>'
                );
            } else if ($(this).hasClass('btn_deleteHba')) {
                url = '<?php echo site_url("Campy_hemoflow_qpcr/delete_detailHba"); ?>/' + id;
                ...
                url = '<?php echo site_url("Campy_hemoflow_qpcr/delete_detailBiochemical"); ?>/' + id;
        ...
        table = $("#example2").DataTable({
            ...
            info: false,
            bFilter: false,
            ajax: {"url": "../../Campy_hemoflow_qpcr/subjsonMpnpcr?idMpnpcr="+id_campy_hemoflow_qpcr, "type": "POST"},
            columns: [
            ...
            rowCallback: function(row, data, iDisplayIndex) {
                ...
                if (info.iTotal > 0) {
                    $('#addtombol_detResultsMpnpcr').prop("disabled", true);
                } else {
                    $('#addtombol_detResultsMpnpcr').show();
                }
            }
        });
        ...
        // NEW: Auto-generate biochemical after MPN PCR data is loaded
        table.ajax.reload(function() {
            let td = $('#example2 td:first');
            let data = table.row(td).data();
            console.log('MPN PCR Data:', data);

            if (data) {
                const growthPlateArray = data.growth_plate.split(', ');
                const plateNumberArray = data.plate_number.split(', ');

                // Generate the biochemical results directly from MPN PCR results
                generateResultBiochemicalFromMpnpcr($('#content-result-biochemical'), plateNumberArray.length, data.id_campy_hemoflow_qpcr, plateNumberArray, growthPlateArray);
            } else {
                console.log('MPN PCR Data belum tersedia');
                $('#content-result-biochemical').empty().append('<p class="text-center">No MPN PCR data available</p>');
            }
        });

        // COMMENTED: HBA Table - Future Use
        /*
        table1 = $("#exampleHba").DataTable({
            ...
            info: false,
            bFilter: false,
            ajax: {"url": "../../Campy_hemoflow_qpcr/subjsonHba?idHba="+id_campy_hemoflow_qpcr, "type": "POST"},
            columns: [
                {"data": "campy_assay_barcode"},
                {"data": "date_sample_processed"},
                {"data": "time_sample_processed"},
            ...
            rowCallback: function(row, data, iDisplayIndex) {
                ...
                if (data.growth_plate) {
                    ...
                    if (allZero) {
                        ...
                        $(row).attr('title', 'Auto-generated from Results MPN-PCR');
                    }
                }
            }
        });
        ...
        table1.ajax.reload(function() {
            ...
            if (data) {
                ...
                generateResultBiochemical($('#content-result-biochemical'), plateNumberArray.length, data.id_campy_hemoflow_qpcr, plateNumberArray, growthPlateArray);
            } else {
        ...
        */
        ...
        // NEW: Generate Biochemical directly from MPN PCR results
        function generateResultBiochemicalFromMpnpcr(container, numberOfPlates, id_campy_hemoflow_qpcr, plateNumberArray, growthPlateArray) {
            ...
            for (let i = 0; i < numberOfPlates; i++) {
                ...
                if (userLevel != 4) {
                    ...
                    // FIXED LOGIC: Disable button if growth plate is 0 (same as original HBA logic)
                ...
                console.log('Biochemical button - Tube:', plateNumber, 'PCR-Tube:', growthPlateArray[i], 'Disabled:', isDisabled, 'User level:', userLevel);
                ...
                initializeDataTableFromMpnpcr(tableId, id_campy_hemoflow_qpcr, plateNumber); // Pass the actual plate number
            }
        }

        // NEW: Initialize DataTable for biochemical from MPN PCR (without HBA dependency)
        function initializeDataTableFromMpnpcr(tableId, id_campy_hemoflow_qpcr, tubeIndex) {
            ...
            $(`#${tableId}`).DataTable({
                ...
                bFilter: false,
                ajax: {
                    url: `../../Campy_hemoflow_qpcr/subjsonBiochemicalFromMpnpcr?idMpnpcr=${id_campy_hemoflow_qpcr}&biochemical_tube=${tubeIndex}`,
                    type: "POST"
                },
                columns: [
                    {"data": "gramlysis"},
        ...
        // COMMENTED: Original HBA-based generateResultBiochemical function - Future Use
        /*
        function generateResultBiochemical(container, numberOfPlates, id_campy_hemoflow_qpcr, plateNumberArray, growthPlateArray) {
            container.empty(); // Clear existing content
            ...
            for (let i = 0; i < numberOfPlates; i++) {
                ...
                // Initialize DataTable for the newly created table, passing the plate number
                initializeDataTable(tableId, id_campy_hemoflow_qpcr, plateNumber); // Pass the actual plate number
            }
        }
        */
        ...
        function initializeDataTable(tableId, id_campy_hemoflow_qpcr, tubeIndex) {
            console.log(`Tube index: ${tubeIndex}`);
            $(`#${tableId}`).DataTable({
                oLanguage: {
                    sProcessing: "Loading data, please wait..."
                ...
                bFilter: false,
                ajax: {
                    url: `../../Campy_hemoflow_qpcr/subjsonBiochemical?idBiochemical=${id_campy_hemoflow_qpcr}&biochemical_tube=${tubeIndex}`,
                    type: "POST"
                },
                columns: [
                    {"data": "gramlysis"},
        ...
        // NEW: Event listener untuk tombol "New Data" - Biochemical from MPN PCR
        $(document).on('click', '[id^=addtombol_detResultsBiochemical_]', function() {
            ...
            // NEW: Get data from MPN PCR table (table) instead of HBA table (table1)
            let td = $('#example2 td:first');
            let data = table.row(td).data();
            console.log('MPN PCR data for biochemical:', data);
            ...
            $('#id_campy_hemoflow_qpcrBiochemical').val(id_campy_hemoflow_qpcr);
            // NEW: No longer need HBA ID since we bypass HBA
            // $('#id_campy_hemoflow_qpcr_result_hba1').val(data.id_campy_hemoflow_qpcr_result_hba);
            $('#gramlysis').val('');
            $('#oxidase').val('');
            $('#catalase').val('');
            // $('#confirmation').val('');
        ...
        $(document).on('click', '.btn_edit_detResultsBiochemical', function() {
            ...
            $('#idBiochemical_one_water_sample').val(idx_one_water_sample);
            $('#id_campy_hemoflow_qpcr_result_biochemical').val(data.id_campy_hemoflow_qpcr_result_biochemical);
            $('#id_campy_hemoflow_qpcrBiochemical').val(data.id_campy_hemoflow_qpcr);
            // NEW: No longer need HBA ID since we bypass HBA for new biochemical approach
            // $('#id_campy_hemoflow_qpcr_result_hba1').val(data.id_campy_hemoflow_qpcr_result_hba);
        ...
        $('#addtombol_detResultsMpnpcr').click(function() {
            $('#mode_detResultsMpnpcr').val('insert');
            $('#modal-title-detail').html('<i class="fa fa-wpforms"></i> Insert | Results MPN-PCR <span id="my-another-cool-loader"></span>');
            $('#idMpnpcr_one_water_sample').val(idx_one_water_sample);
            $('#campy_assay_barcode1').val(campy_assay_barcode);
            $('#campy_assay_barcode1').attr('readonly', true);
            $('#id_campy_hemoflow_qpcr1').val(id_campy_hemoflow_qpcr);
        ...
        $('#example2').on('click', '.btn_edit_detResultsMpnpcr', function() {
            let tr = $(this).closest('tr');
            let data = table.row(tr).data();
            console.log(data);
            $('#mode_detResultsMpnpcr').val('edit');
            $('#modal-title-detail').html('<i class="fa fa-pencil-square"></i> Update | Results MPN-PCR <span id="my-another-cool-loader"></span>');
            $('#idMpnpcr_one_water_sample').val(idx_one_water_sample);
            $('#id_campy_hemoflow_qpcr_result_mpnpcr').val(data.id_campy_hemoflow_qpcr_result_mpnpcr);
            $('#campy_assay_barcode1').val(data.campy_assay_barcode);
            $('#campy_assay_barcode1').attr('readonly', true);
            $('#id_campy_hemoflow_qpcr1').val(data.id_campy_hemoflow_qpcr);
        ...
        $('#addtombol_detResultsHBA').on('click', function() {
            ...
            if (data && data.campy_assay_barcode) {
                ...
                $('#id_campy_hemoflow_qpcrHBA').val(id_campy_hemoflow_qpcr);
                ...
                // Always enable Quality Control - not affected by MPN-PCR growth plates
                qualityControlCheckbox.prop('disabled', false);
                qcNotice.hide();
                ...
                $('#confirm-modal .modal-body').html('<p class="text-center" style="font-size: 15px;">You have not filled in the Result MPN-PCR. Please fill in that data first.</p>');
            }
        });
        ...
        $('#exampleHba').on('click', '.btn_edit_detResultsHba', function() {
            ...
            $('#idHba_one_water_sample').val(idx_one_water_sample);
            $('#id_campy_hemoflow_qpcr_result_hba').val(data.id_campy_hemoflow_qpcr_result_hba);
            $('#campy_assay_barcodeHBA').val(data.campy_assay_barcode);
            $('#campy_assay_barcodeHBA').attr('readonly', true);
            $('#id_campy_hemoflow_qpcrHBA').val(data.id_campy_hemoflow_qpcr);
        ...
        $('#formCalculateMPN').submit(function(e) {
            ...
            let url = '<?php echo site_url("Campy_hemoflow_qpcr/saveCalculateMPN"); ?>';
