                        ...
                        <div class="form-group" id="mpn_pcr_conducted">
                            ...
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <input type="radio" name="mpn_pcr_conducted" value="Yes"> Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="mpn_pcr_conducted" value="No"> No
                                </label>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#addtombol').click(function() {
            ...
            if (sampleVolumeInputs.children().length > 1) {
                ...
                sampleVolumeInputs.append('<input id="vol_sampletube1" name="vol_sampletube1" type="number" step="0.01" class="form-control sample-input" placeholder="Volume of The Sample(uL) Tube1" required>');
            }
            $('#barcode_moisture_content').val('');
