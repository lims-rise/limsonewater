            ...
            if (gramLysisValue && oxidaseValue) {
                ...
                if (gramLysisValue === 'Positive') {
                    ...
                    if (oxidaseValue === 'Positive') {
                        confirmationText = 'Detected';  // Grim=Yes + Oxidase=Yes = Campy
                    } else {
                        confirmationText = 'Not detected';  // Grim=Yes + Oxidase=No = Not Campy
                    }
                } else {
                    // If Gram-lysis is Negative (No)
                    confirmationText = 'Not detected';  // Grim=No = Always Not Campy
                }
            } else {
