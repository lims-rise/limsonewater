    ...
    <section class="content">
            ...
            <div class="col-xs-12">
                <div class="box box-black box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Master Data - Kit</h3>
                    </div>
        ...
        <div style="padding-bottom: 10px;">
            <?php
                    ...
                    if ($lvl != 4){
                        echo "<button class='btn btn-primary' id='addtombol'><i class='fa fa-wpforms' aria-hidden='true'></i> New Kit </button>";
                    }
            ?>
        
		    <!-- <?php echo anchor(site_url('Ref_kit/excel'), '<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export to CSV', 'class="btn btn-success"'); ?> -->
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box">
                    ...
                    <h4 class="modal-title" id="modal-title">Master Data - New Kit</h4>
                </div>
                <form id="formSample"  action= <?php echo site_url('Ref_kit/save') ?> method="post" class="form-horizontal">
                    <div class="modal-body">
                        <input id="mode" name="mode" type="hidden" class="form-control input-sm">
                        <input id="id_kit" name="id_kit" type="hidden" class="form-control input-sm">

                        <div class="form-group">
                            <label for="kit" class="col-sm-4 control-label">Kit Name</label>
                            <div class="col-sm-8">
                                <input id="kit" name="kit" type="text" class="form-control" placeholder="Kit" value="<?php echo date("Y-m-d"); ?>">
                            </div>
                            </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "Ref_kit/valid_bs?id1="+data1,
        //         data:data1,
        //         dataType: "json",
        ...
        table = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Ref_kit/json", "type": "POST"},
            columns: [
                // {
                //     "data": "barcode_sample",
                //     "orderable": false
        ...
        $('#addtombol').click(function() {
            $('.val1tip').tooltipster('hide');   
            $('#mode').val('insert');
            $('#modal-title').html('<i class="fa fa-wpforms"></i> Master Data - New kit<span id="my-another-cool-loader"></span>');
            $('#id_kit').val('');
        ...
        $('#mytable').on('click', '.btn_edit', function(){
            ...
            $('#mode').val('edit');
            $('#modal-title').html('<i class="fa fa-pencil-square"></i> Master Data - Update kit<span id="my-another-cool-loader"></span>');
