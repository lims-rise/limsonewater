...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#mytable").DataTable({
            ...
            //         let now = new Date();
            //         console.log('date create',createdDate);
            //         console.log('date now',createdDate);
                    
            //         console.log('date result', now - createdDate < 10 * 1000);
            ...
            //         // Simpan baris dengan date_created terbaru
        ...
        // $(document).on('submit', '#edit-sample-form', function (e) {
        //     e.preventDefault();

        //     let formData = $(this).serialize();

        //     $.ajax({
        //         url: "Sample_reception/update_sample",
        //         type: "POST",
        //         data: formData,
        //         dataType: "json",
        //         success: function (response) {
        ...
        //             if (response.status === "success") {
        //                 alert(response.message);
        //                 $('#compose-modal-sample').modal('hide');
        //                 location.reload();
        //             } else {
        ...
        // $(document).on('click', '.btn_edit_sample', function () {
        ...
        //                         <label for="time_arrival" class="col-sm-4 col-form-label">Time Arrive</label>
        //                         <div class="col-sm-8">
        //                             <input id="time_arrival" name="time_arrival" class="form-control" type="time">
        //                         </div>
        //                     </div>
        ...
        //                     <div class="form-group">
        //                         <label for="time_collected" class="col-sm-4 col-form-label">Time Collected</label>
        //                         <div class="col-sm-8">
        //                             <input id="time_collected" name="time_collected" class="form-control" type="time">
        //                             <span id="time_collected_error" class="text-danger d-none">Time collected cannot be greater than or equal to time arrival.</span>
        //                         </div>
        //                     </div>
        ...
        //                 </form>
        //             `;
        //             $('#modal-sample-body').html(formContent);
        ...
        //             // Toggle date input based on the selection
        //             function toggleDateInput() {
        ...
        //             // Handle click on quality check label
        //             const states = [
        ...
        //             $('#quality_check_label').on('click', function () {
        //                 currentState = (currentState + 1) % states.length;
        //                 const checkbox = $('#quality_check');
        //                 const label = $('#quality_check_label');
                        
        //                 label.text(states[currentState].label);
        //                 label.attr('class', `form-check-label ${states[currentState].class}`);
        //                 checkbox.val(states[currentState].value); // Set the value to current state
        //             });

        //             // Validate time collected vs time arrival
        ...
        //                         $('#time_collected_error').text('Time collected cannot be greater than or equal to time arrival.').show();
        //                         isValid = false;
        //                     }
        //                 }
        ...
        //                         <div class="col-sm-8">
        //                             <!-- Dropdown untuk memilih antara tanggal atau NA -->
        //                             <select id="date_selector" name="date_collected" class="form-control">
        //                                 <option value="date">Select Date</option>
        //                                 <option value="NA">NA</option>
        //                             </select>

        //                             <!-- Input tanggal yang hanya bisa dipilih jika bukan 'NA' -->
        //                             <input id="date_collected" name="date_collected" type="date" class="form-control" 
        ...
        //             // Set the checkbox state
        //             if (data.quality_check == 1) {
        //                 $('#quality_check').prop('checked', true);
        //                 const label = document.getElementById('quality_check_label');
        //                 label.textContent = 'Checked';
        //                 label.className = `form-check-label checked`;
        //             } else if (data.quality_check == 0) {
        ...
        //             // Panggil validasi ketika waktu pengambilan diubah
        //             $('#time_collected').on('change', function () {
        //                 validateTimeCollected(); // Jalankan validasi saat waktu pengambilan berubah
        //             });

        //             // Memastikan validasi dijalankan sebelum submit form
        //             $('form').on('submit', function (e) {
        //                 if (!validateTimeCollected()) {
        ...
        //             function validateTimeCollected() {
        //                 let timeArrival = $('#time_arrival').val(); // Ambil nilai waktu kedatangan
        //                 let timeCollected = $('#time_collected').val(); // Ambil nilai waktu pengambilan
        //                 let isValid = true; // Indikator validitas

        //                 $('#time_collected_error').hide(); // Sembunyikan error sebelumnya

        //                 // Cek apakah waktu pengambilan kosong
        //                 if (!timeCollected) {
        //                     $('#time_collected_error').text('Time collected cannot be empty.').show(); // Tampilkan pesan error
        //                     isValid = false;
        //                 } else {
        //                     // Pecah waktu kedatangan dan pengambilan menjadi bagian jam dan menit
        //                     let arrivalParts = timeArrival.split(':');
        //                     let collectedParts = timeCollected.split(':');

        //                     // Membuat objek Date untuk waktu kedatangan
        //                     let arrivalDate = new Date();
        //                     arrivalDate.setHours(arrivalParts[0], arrivalParts[1], 0); // Jam dan menit

        //                     // Membuat objek Date untuk waktu pengambilan
        //                     let collectedDate = new Date();
        //                     collectedDate.setHours(collectedParts[0], collectedParts[1], 0); // Jam dan menit

        //                     // Bandingkan waktu pengambilan dan waktu kedatangan
        //                     if (collectedDate >= arrivalDate) {
        //                         $('#time_collected_error').text('Time collected cannot be greater than or equal to time arrival.').show();
        //                         isValid = false; // Waktu pengambilan lebih besar atau sama dengan kedatangan
        //                     }
        //                 }

        //                 // Jika valid, simpan kembali waktu pengambilan; jika tidak valid, kosongkan input
        //                 if (isValid) {
        //                     $('#time_collected').val(timeCollected);
        //                 } else {
        //                     $('#time_collected').val(''); // Kosongkan input jika tidak valid
        //                 }
        ...
        //             // Panggil saat pertama kali modal terbuka
        //             toggleDateInput();
