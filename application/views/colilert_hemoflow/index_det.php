			...
			<div class="box-footer">
				...
				<div class="form-group">
					<div class="modal-footer clearfix">
                        <button type="button" name="batal" value="batal" class="btn btn-warning" onclick='window.location.href=<?= json_encode(isset($return_url) ? $return_url : site_url("colilert_hemoflow")); ?>;'>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                        <div class="col-sm-9">
                                            ...
                                            <input id="return_urlDetail" name="return_url" type="hidden" value="<?= htmlspecialchars(isset($return_url) ? $return_url : site_url('colilert_hemoflow'), ENT_QUOTES, 'UTF-8'); ?>" class="form-control input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="lowerconfidence" name="lowerconfidence" type="text"  placeholder="Lower confidence limit MPN/100 mL" class="form-control" readonly>
                                            <!-- <div class="val1tip"></div> -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input id="coliforms" name="coliforms" type="text"  placeholder="Coliforms (MPN/100mL)" class="form-control" readonly>
                                            <!-- <div class="val1tip"></div> -->
                                        </div>
                                    </div>
    ...
    $(document).ready(function() {
	  ...
	  $('#review_label')
        ...
        $('#ecoli_largewells').on('input change', function(event) {        
            performCalculation('#ecoli_largewells', '#ecoli_smallwells', ['#ecoli', '#lowerconfidence']);
        });
        ...
        $('#coliforms_largewells').on('input change', function(event) {        
            performCalculation('#coliforms_largewells', '#coliforms_smallwells', ['#coliforms']);
        });
