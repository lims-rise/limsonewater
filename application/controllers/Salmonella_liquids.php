...
class Salmonella_liquids extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_template_with_announcements('template', 'salmonella_liquids/index', $data);
    } 
    ...
    public function read($id)
    {
        ...
        if (!$this->is_valid_return_url($return_url)) {
            $return_url = site_url("salmonella_liquids");
        }
    ...
    public function saveResultsXld() {
        ...
        $redirect_url = site_url("salmonella_liquids/read/" . $id_one_water_sample);
        if ($this->is_valid_return_url($return_url)) {
