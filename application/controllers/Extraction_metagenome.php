...
class Extraction_metagenome extends CI_Controller
{
    ...
    public function excel()
    {
        ...
        $sheets = array(
            ...
            //     FROM Extraction_metagenome_detail a
            //     LEFT JOIN Extraction_metagenome c ON a.id_req=c.id_req
	...
	{
        /* Data */
        $data = $this->Extraction_metagenome_model->get_all_with_detail_excel($id);
        ...
        $writer = new Xlsx($spreadsheet);
        ob_clean();
        $filename = 'Extraction_metagenome_'. $obj .'_'. date('Ymd');
