...
class Salmonella_biosolids extends CI_Controller
{
    ...
    public function excel($id) {
        ...
        header('Content-Disposition: attachment;filename="Report_Salmonella_Final_Concentrations.xlsx"');
    ...
    public function excel_all() {
        ...
        header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
        header('Content-Disposition: attachment;filename="Report_All_Salmonella_Final_Concentrations.xlsx"');
        header('Cache-Control: max-age=0');
