...
class Salmonella_biosolids extends CI_Controller
{
    ...
    public function subjsonXld() {
        ...
        header('Content-Type: application/json');
        echo $this->Salmonella_biosolids_model->subjsonXld($id);
    }

    public function subjsonChromagar() {
        $id = $this->input->get('idChromagar',TRUE);
        header('Content-Type: application/json');
        echo $this->Salmonella_biosolids_model->subjsonChromagar($id);
    }
    ...
    public function saveResultsXld() {
        ...
        if ($mode == "insert") {
            ...
            $assay_id = $this->Salmonella_biosolids_model->insertResultsXld($data);
            ...
            for ($i = 1; $i <= $number_of_tubes; $i++) {
                ...
                if ($plate !== null) {
                    $this->Salmonella_biosolids_model->insert_black_colony_plate_chromagar(array(
            ...
            $this->autoSaveChromagarIfAllZero($id_salmonella_biosolids, $number_of_tubes, $date_sample_processed, $time_sample_processed);
            ...
            $this->Salmonella_biosolids_model->updateResultsXld($id_result_xld, $data);

            // Update sample volumes
            $number_of_tubes = $this->input->post('number_of_tubes1', TRUE);
            $this->Salmonella_biosolids_model->delete_black_colony_plates_chromagar($id_result_xld); // Hapus volume yang ada
            ...
            for ($i = 1; $i <= $number_of_tubes; $i++) {
                ...
                if ($plate !== null) {
                    ...
                    $this->Salmonella_biosolids_model->insert_black_colony_plate_Chromagar($data_plate);
                }
            }
    ...
    public function saveResultsChromagar() {
        ...
        if ($mode == "insert") {
            ...
            $assay_id = $this->Salmonella_biosolids_model->insertResultsChromagar($data);
            ...
            for ($i = 1; $i <= $number_of_tubes; $i++) {
                ...
                if ($plate !== null) {
                    $this->Salmonella_biosolids_model->insert_purple_colony_plate(array(
            ...
            $this->Salmonella_biosolids_model->updateResultsChromagar($id_result_chromagar, $data);
    
            // Update sample volumes
            $number_of_tubes = $this->input->post('number_of_tubesChromagar', TRUE);
            $this->Salmonella_biosolids_model->delete_purple_colony_plates($id_result_chromagar); // Hapus volume yang ada
            ...
            for ($i = 1; $i <= $number_of_tubes; $i++) {
                ...
                if ($plate !== null) {
                    ...
                    $this->Salmonella_biosolids_model->insert_purple_colony_plate($data_plate);
                }
            }
     ...
     */
    private function autoSaveChromagarIfAllZero($id_salmonella_biosolids, $number_of_tubes, $date_sample_processed, $time_sample_processed) {
        $dt = new DateTime();
        ...
        if ($all_zero) {
            ...
            $existing_chromagar = $this->Salmonella_biosolids_model->getAllChroMagarResults($id_salmonella_biosolids);
            ...
            if (empty($existing_chromagar)) {
                ...
                $chromagar_id = $this->Salmonella_biosolids_model->insertResultsChromagar($chromagar_data);
                ...
                for ($i = 1; $i <= $number_of_tubes; $i++) {
                    ...
                    $this->Salmonella_biosolids_model->insert_purple_colony_plate($plate_data);
                }
                
                // Auto-generate biochemical results
                $this->autoGenerateBiochemicalResults($id_salmonella_biosolids, $chromagar_id, $number_of_tubes);
    ...
    // }
        ...
        if (!$mode || !$id_salmonella_biosolids || !$confirmation || !$biochemical_tube) {
            if ($is_ajax) {
                echo json_encode([
                    'status' => 'error',
        ...
        try {
            if ($mode == "insert") {
                ...
                $result = $this->Salmonella_biosolids_model->insertResultsBiochemical($data);
    ...
    public function barcode_restrict() 
    {
        ...
        $data = $this->Salmonella_biosolids_model->barcode_restrict($id);
        header('Content-Type: application/json');
        echo json_encode($data);
    }
    ...
    public function saveReview()
    {
        ...
        try {
            $this->Salmonella_biosolids_model->update_salmonella_biosolids($id, $data);
            echo json_encode([
                'status' => true,
    ...
    public function cancelReview()
    {
        ...
        $this->load->model('Salmonella_biosolids_model');
        $updateResult = $this->Salmonella_biosolids_model->updateCancel($id, $data);
    ...
    public function checkTubeExists() {
        try {
            $id_salmonella_biosolids = $this->input->post('id_salmonella_biosolids');
            $biochemical_tube = $this->input->post('biochemical_tube');
            
            if (!$id_salmonella_biosolids || !$biochemical_tube) {
                echo json_encode([
                    'status' => 'error',
            ...
            $exists = $this->Salmonella_biosolids_model->checkTubeExists($id_salmonella_biosolids, $biochemical_tube);
    ...
    public function checkTubeNeedsUpdate() {
        ...
        try {
            ...
            if (!$id_salmonella_biosolids || !$biochemical_tube || !$expected_confirmation) {
                echo json_encode([
                    'status' => 'error',
                    'message' => 'Missing required parameters.',
                    'exists' => false,
            ...
            $result = $this->Salmonella_biosolids_model->checkTubeNeedsUpdate($id_salmonella_biosolids, $biochemical_tube, $expected_confirmation);
    ...
    public function checkAnyTubeExists() {
        try {
            ...
            $hasData = $this->Salmonella_biosolids_model->checkAnyTubeExists($id_salmonella_biosolids);
