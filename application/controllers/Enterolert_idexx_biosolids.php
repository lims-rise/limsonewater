...
class Enterolert_idexx_biosolids extends CI_Controller
{
    ...
    public function read($id)
    {
        ...
        if (!$this->is_valid_return_url($return_url)) {
            $return_url = site_url("enterolert_idexx_biosolids");
        }
    ...
    public function savedetail() {
            ...
            $redirect_url = site_url("enterolert_idexx_biosolids/read/" . $id_one_water_sample);
            if ($this->is_valid_return_url($return_url)) {
    ...
    public function saveReview()
    {
        ...
        $this->load->model('Enterolert_idexx_biosolids_model');
        $this->Enterolert_idexx_biosolids_model->updateSave($id, $data);
        echo json_encode([
            'status' => true,
    ...
    public function cancelReview()
    {
        ...
        $this->load->model('Enterolert_idexx_biosolids_model');
        $updateResult = $this->Enterolert_idexx_biosolids_model->updateCancel($id, $data);
    ...
    {
        $idOneWaterSample = $this->input->post('id_one_water_sample');
        $oneWaterSample = $this->Enterolert_idexx_biosolids_model->checkDryWeight($idOneWaterSample);
