...
class Colilert_idexx_biosolids extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_template_with_announcements('template', 'colilert_idexx_biosolids/index', $data);
    } 
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->load_template_with_announcements('template', 'colilert_idexx_biosolids/index_det', $data);
    ...
    public function savedetail() {
            ...
            $ecoli = $this->input->post('ecoli', FALSE); // FALSE to prevent XSS encoding of < symbol
            $lowerdetection = $this->input->post('lowerdetection', TRUE);
            $ecoli_dryweight = $this->input->post('ecoli_dryweight', FALSE); // FALSE to prevent XSS encoding of < symbol
            ...
            $total_coliforms = $this->input->post('total_coliforms', FALSE); // FALSE to prevent XSS encoding of < symbol
            $total_coliforms_mpn_dry_weight = $this->input->post('total_coliforms_mpn_dry_weight', FALSE); // FALSE to prevent XSS encoding of < symbol
    ...
    public function saveReview()
    {
        ...
        $this->load->model('Colilert_idexx_biosolids_model');
        $this->Colilert_idexx_biosolids_model->updateSave($id, $data);
        echo json_encode([
            'status' => true,
    ...
    public function cancelReview()
    {
        ...
        $this->load->model('Colilert_idexx_biosolids_model');
        $updateResult = $this->Colilert_idexx_biosolids_model->updateCancel($id, $data);
