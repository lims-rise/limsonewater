...
class Campy_liquids extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $this->load_template_with_announcements('template', 'campy_liquids/index', $data);
    } 
    ...
    public function read($id)
    {
        ...
        if (!$this->is_valid_return_url($return_url)) {
            $return_url = site_url("campy_liquids");
        }
    ...
    public function saveResultsCharcoal() {
        ...
        $redirect_url = site_url("campy_liquids/read/" . $id_one_water_sample);
        if ($this->is_valid_return_url($return_url)) {
