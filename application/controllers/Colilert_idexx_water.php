...
class Colilert_idexx_water extends CI_Controller
{
    ...
    public function read($id)
    {
        ...
        if (!$this->is_valid_return_url($return_url)) {
            $return_url = site_url("colilert_idexx_water");
        }
    ...
    public function savedetail() {
            ...
            $redirect_url = site_url("colilert_idexx_water/read/" . $id_one_water_sample);
            if ($this->is_valid_return_url($return_url)) {
    ...
    public function saveReview()
    {
        ...
        $this->load->model('Colilert_idexx_water_model');
        $this->Colilert_idexx_water_model->updateSave($id, $data);
        echo json_encode([
            'status' => true,
    ...
    public function cancelReview()
    {
        ...
        $this->load->model('Colilert_idexx_water_model');
        $updateResult = $this->Colilert_idexx_water_model->updateCancel($id, $data);
